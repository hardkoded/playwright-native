...
namespace PlaywrightSharp.Tests
{
    ...
    public class LaunchPersistentRecordHarUrlTests : PageTestEx
    {
        ...
        public async Task LaunchPersistentContextAsyncShouldHonorRecordHarUrl()
        {
            ...
            try
            {
                IBrowserContext context = await browserType.LaunchPersistentContextAsync(userDataDir, new PlaywrightSharp.Compat.LegacyBrowserTypeLaunchPersistentContextOptions
                {
