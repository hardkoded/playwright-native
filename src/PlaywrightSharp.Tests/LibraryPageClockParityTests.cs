    ...
    public class LibraryPageClockParityTests : PageTestEx
    {
        ...
        public async Task TriggersEventWhenSomeThrow()
        {
            ...
            await _page.EvaluateAsync(
                ...
                .ConfigureAwait(false);
            Assert.ThrowsAsync<PlaywrightSharpException>(
        ...
        {
            await InstallPausedAsync().ConfigureAwait(false);
            PlaywrightSharpException invalidDate = Assert.ThrowsAsync<PlaywrightSharpException>(
            ...
            PlaywrightSharpException invalid = Assert.ThrowsAsync<PlaywrightSharpException>(
