...
namespace PlaywrightSharp.Tests
{
  ...
  ").ConfigureAwait(false);
        ...
        public async Task ShouldThrowForHiddenNodesWithForce()
        {
            ...
            PlaywrightSharpException error = Assert.CatchAsync<PlaywrightSharpException>(() => button.ClickAsync(new() { Force = true }));
            Assert.That(error, Is.Not.Null);
        ...
        public async Task ShouldThrowForBrElementsWithForce()
        {
            ...
            PlaywrightSharpException error = Assert.CatchAsync<PlaywrightSharpException>(() => br.ClickAsync(new() { Force = true }));
            Assert.That(error, Is.Not.Null);
