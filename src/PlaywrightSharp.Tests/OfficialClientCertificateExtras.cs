...
namespace PlaywrightSharp.Tests
{
    ...
    internal sealed class OfficialPlaywrightTestHttpsServer : IAsyncDisposable
    {
        ...
        {
            string certPath = Path.Combine(TestUtils.FindParentDirectory("PlaywrightSharp.TestServer"), "playwright-test.pem");
            string keyPath = Path.Combine(TestUtils.FindParentDirectory("PlaywrightSharp.TestServer"), "playwright-test-key.pem");
