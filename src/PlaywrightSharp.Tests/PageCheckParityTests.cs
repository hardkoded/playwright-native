    ...
    <script>
      checkbox.addEventListener('click', () => checkbox.setAttribute('aria-checked', 'false'));
        ...
        public async Task ShouldThrowWhenNotACheckbox()
        {
            ...
            PlaywrightSharpException error = Assert.CatchAsync<PlaywrightSharpException>(() => page.CheckAsync("div"));
    ...
    <label for='checkbox'>
      ...
      Click me
        ...
        public async Task ShouldThrowWhenTryingToUncheckRadioButton()
        {
            ...
            PlaywrightSharpException error = Assert.CatchAsync<PlaywrightSharpException>(() => page.UncheckAsync("#radio"));
            Assert.That(error, Is.Not.Null);
