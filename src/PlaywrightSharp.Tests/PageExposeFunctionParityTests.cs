...
namespace PlaywrightSharp.Tests
{
    ...
    public class PageExposeFunctionParityTests : PageTestEx
    {
        ...
        public async Task ShouldDispose()
        {
            ...
            PlaywrightSharpException exception = Assert.ThrowsAsync<PlaywrightSharpException>(
        ...
        public async Task ShouldThrowExceptionInPageContext()
        {
            ...
            await page.ExposeFunctionAsync("woof", (Action)(() => throw new PlaywrightSharpException("WOOF WOOF"))).ConfigureAwait(false);
