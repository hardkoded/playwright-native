...
namespace PlaywrightNative.Compat
{
...
#pragma warning restore CA2225
    ...
    {
        /// <summary>Cancellation token (PlaywrightNative tests only).</summary>
    ...
    public class LegacyAPIRequestNewContextOptions : Microsoft.Playwright.APIRequestNewContextOptions
    {
        ...
        /// <summary>Resolved credentials for PlaywrightNative dispatch.</summary>
