...
namespace PlaywrightNative.WebKit
{
    ...
    internal sealed partial class WebKitMouse : IMouse
    {
        private readonly Input.Mouse _mouse;
        private readonly IBrowserContext _context;

        internal WebKitMouse(Input.Mouse mouse, IBrowserContext context)
        {
        ...
        public Task DblClickAsync(float x, float y, MouseButton button = default, float? delay = null, int? steps = null)
            => Helpers.ActionTrace.RunAsync(
                _context,
                "Double click",
                "Mouse",
                "dblclick",
                () => _mouse.DoubleClickAsync(
                    x,
                    y,
                    ToInputMouseButton(button),
                    delay.HasValue ? (int)delay.Value : 0,
...
#pragma warning disable SA1137, SA1201, SA1202, SA1208, SA1210, SA1502, SA1518, SA1600, SA1601, SA1611, SA1615, SA1648
        ...
        // call these; stubs here made every WebKit click a silent no-op.
