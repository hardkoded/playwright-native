...
namespace PlaywrightNative.WebKit
{
    ...
    {
        private static readonly IReadOnlyDictionary<string, string[]> _commands = new Dictionary<string, string[]>
        {
        ...
        /// shortcut has no associated command.
        /// </summary>
        /// <param name="shortcut">The shortcut, e.g. <c>"Enter"</c> or <c>"Shift+ArrowLeft"</c>.</param>
        /// <returns>The ordered list of editing commands, possibly empty.</returns>
        internal static string[] Resolve(string shortcut)
            => _commands.TryGetValue(shortcut, out string[] commands) ? commands : System.Array.Empty<string>();
    }
}
