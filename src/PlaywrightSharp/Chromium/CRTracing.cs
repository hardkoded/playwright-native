...
namespace PlaywrightSharp.Chromium
{
    ...
    internal sealed partial class CRTracing : ITracing
    {
        ...
        /// <inheritdoc/>
        public Task StartAsync(PlaywrightSharp.TracingStartOptions options)
        {
        ...
        public async Task StartAsync(string categories = null)
        {
            lock (_gate)
            {
                if (_recording)
                {
                    throw new PlaywrightSharpException("Tracing has already been started.");
                }
        ...
        public Task StartChunkAsync(string name = default, string title = default)
        {
            ...
            lock (_gate)
            {
                if (!_recording)
                {
                    throw new PlaywrightSharpException("Tracing has not been started.");
                }
        ...
        private OfficialTraceSession OfficialSession()
        {
            ...
            throw new PlaywrightSharpException("Tracing is not bound to a browser context.");
        }
