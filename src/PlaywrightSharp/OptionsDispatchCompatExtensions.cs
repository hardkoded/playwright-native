...
using PlaywrightSharp.Compat;
using PlaywrightSharp.Helpers;

namespace PlaywrightSharp
{
    /// <summary>
    /// Dispatches compat option bags that carry PlaywrightSharp-only fields.
    /// </summary>
    public static class OptionsDispatchCompatExtensions
    {
        /// <summary>Legacy click with PlaywrightSharp steps option.</summary>
        ...
        /// <summary>Legacy frame click with PlaywrightSharp steps option.</summary>
        [OverloadResolutionPriority(1)]
        ...
        public static Task WaitForLoadStateAsync(this IPage page, LegacyPageWaitForLoadStateOptions options)
        {
            if (options?.State is string stateText)
            {
                ...
                throw new PlaywrightSharpException("state: expected one of (load|loadstate|domcontentloaded|networkidle|commit)");
            }
        ...
        public static Task<IJSHandle> WaitForFunctionAsync(
            ...
            => locator is Locator concrete
                ...
                : throw new NotSupportedException("WaitForFunctionAsync requires a PlaywrightSharp locator.");

        /// <summary>Legacy locator click with PlaywrightSharp signal/steps options.</summary>
        [OverloadResolutionPriority(1)]
