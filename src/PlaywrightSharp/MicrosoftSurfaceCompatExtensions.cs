...
{
    /// <summary>
    /// Surface helpers that exist on PlaywrightSharp implementations but are missing from
    ...
    public static class MicrosoftSurfaceCompatExtensions
    {
            ...
            bool? strict = default)
        {
            ...
            if (handle == null)
            {
                throw new PlaywrightSharpException($"Failed to find element matching selector \"{selector}\"");
            }
            ...
            bool? boxes = default)
        {
            ...
            IElementHandle root = await page.QuerySelectorAsync("html").ConfigureAwait(false)
                ?? throw new PlaywrightSharpException("page.ariaSnapshotJSON: no documentElement.");
            ...
            bool? boxes = default)
        {
            ...
            throw new NotSupportedException("AriaSnapshotJsonAsync requires a PlaywrightSharp locator.");
        }
        ...
        public static Task StartTracingAsync(
            ...
            => browser switch
            {
                ...
                _ => throw new NotSupportedException("startTracing requires a PlaywrightSharp browser."),
            };
        ...
        public static Task<byte[]> StopTracingAsync(this IBrowser browser)
            => browser switch
            {
                ...
                _ => throw new NotSupportedException("stopTracing requires a PlaywrightSharp browser."),
            };

        /// <summary>Local tracing start options overload.</summary>
        public static Task StartAsync(this ITracing tracing, PlaywrightSharp.TracingStartOptions options)
            => tracing switch
            {
            ...
            string resourcesDir = default)
        {
            ...
            throw new NotSupportedException("StartHarAsync requires a PlaywrightSharp tracing instance.");
        }
        ...
        public static Task<IAsyncDisposable> AddInitScriptExposingFunctionsAsync(this IBrowserContext context, string script, object arg = default)
            => context switch
            {
                ...
                _ => throw new NotSupportedException("AddInitScriptExposingFunctionsAsync requires a PlaywrightSharp context."),
            };
        ...
        public static Task ToHaveScreenshotAsync(
            ...
            => assertions is PageAssertions concrete
                ? concrete.ToHaveScreenshotAsync(
                    ...
                    mask,
                    maskColor)
                : throw new NotSupportedException("ToHaveScreenshotAsync requires PlaywrightSharp assertions.");
        ...
        public static Task ToPassAsync(this ILocatorAssertions assertions, Func<Task> assertion, float? timeout = default)
            => assertions is LocatorAssertions concrete
                ...
                : throw new NotSupportedException("ToPassAsync requires PlaywrightSharp assertions.");
        ...
        public static Task<ICDPSession> NewBrowserCDPSessionAsync(this IBrowser browser)
        {
            switch (browser)
            {
                ...
                default:
                    throw new NotSupportedException("NewBrowserCDPSessionAsync requires a PlaywrightSharp browser.");
            }
        }
