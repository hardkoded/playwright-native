...
{
    /// <summary>
    /// Legacy PlaywrightSharp <see cref="ILocator"/> helpers missing from official API.
    /// </summary>
    public static class LocatorCompatExtensions
    {
        /// <summary>Gets the owning frame for a PlaywrightSharp locator.</summary>
        ...
        private static Locator RequireLocator(ILocator locator)
            => locator as Locator
                ?? throw new NotSupportedException("This locator does not support PlaywrightSharp extensions.");
    }
}
