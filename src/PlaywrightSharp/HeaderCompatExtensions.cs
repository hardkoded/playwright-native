...
namespace PlaywrightSharp
{
    ...
    {
        /// <summary>Converts official headers to PlaywrightSharp name/value entries.</summary>
        ...
        /// <summary>Converts PlaywrightSharp entries to official header pairs.</summary>
