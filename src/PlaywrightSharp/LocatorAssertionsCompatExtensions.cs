    ...
    public static class LocatorAssertionsCompatExtensions
    {
        ...
        public static Task ToHaveCountAsync(this ILocatorAssertions assertions, int count, float? timeout = default)
            => assertions is LocatorAssertions sharp
                ...
                : throw new NotSupportedException("ToHaveCountAsync requires PlaywrightSharp assertions.");
        ...
        public static Task ToHaveJSPropertyAsync(
            ...
            => assertions is LocatorAssertions sharp
                ...
                : throw new NotSupportedException("ToHaveJSPropertyAsync requires PlaywrightSharp assertions.");
        ...
        public static Task ToHaveAttributeAsync(
            ...
            => assertions is LocatorAssertions sharp
                ...
                : throw new NotSupportedException("ToHaveAttributeAsync requires PlaywrightSharp assertions.");
        ...
        public static Task ToContainTextAsync(
            ...
            => assertions is LocatorAssertions sharp
                ...
                : throw new NotSupportedException("ToContainTextAsync requires PlaywrightSharp assertions.");
        ...
        public static Task ToContainClassAsync(
            ...
            => assertions is LocatorAssertions sharp
                ...
                : throw new NotSupportedException("ToContainClassAsync requires PlaywrightSharp assertions.");
        ...
        public static Task ToContainTextAsync(
            ...
            => assertions is LocatorAssertions sharp
                ? sharp.ToContainTextAsync(expected, timeout, ignoreCase, useInnerText)
                : throw new System.NotSupportedException("ToContainTextAsync requires PlaywrightSharp assertions.");
        ...
        public static Task ToHaveClassAsync(
            ...
            => assertions is LocatorAssertions sharp
                ...
                : throw new NotSupportedException("ToHaveClassAsync requires PlaywrightSharp assertions.");
    }
}
