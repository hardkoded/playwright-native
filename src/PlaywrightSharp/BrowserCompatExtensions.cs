...
namespace PlaywrightSharp
{
    ...
    {
        /// <summary>
        /// Creates a context from PlaywrightSharp <see cref="BrowserContextOptions"/>.
        /// </summary>
        /// <param name="browser">Browser instance.</param>
        /// <param name="options">PlaywrightSharp context options.</param>
        ...
        /// <summary>
        /// Creates a page in a new context from PlaywrightSharp <see cref="BrowserContextOptions"/>.
        /// </summary>
        /// <param name="browser">Browser instance.</param>
        /// <param name="options">PlaywrightSharp context options.</param>
