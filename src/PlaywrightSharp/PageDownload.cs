...
namespace PlaywrightSharp
{
    ...
    internal sealed partial class PageDownload : IDownload
    {
        ...
        public async Task<string> PathAsync()
        {
            ...
            if (error != null)
            {
                throw new PlaywrightSharpException("download.path: " + error);
            }
            ...
            throw new PlaywrightSharpException("Download finished but the file was not found.");
        }
        ...
        public async Task SaveAsAsync(string path)
        {
            ...
            catch (PlaywrightSharpException ex)
            {
                ...
                throw new PlaywrightSharpException("download.saveAs: " + message, ex);
            }
