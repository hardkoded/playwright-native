...
{
    /// <summary>
    /// WebKit page WebSocket reported via <c>Network.webSocket*</c>.
    /// </summary>
    internal sealed partial class WKWebSocket : IWebSocket, IHasHarWebSocket, IHasOwnerPage
    {
        private readonly PendingWebSocketEvent<IWebSocketFrame> _frameReceived = new PendingWebSocketEvent<IWebSocketFrame>();

        internal WKWebSocket(string requestId, string url, IPage ownerPage = null)
        {
