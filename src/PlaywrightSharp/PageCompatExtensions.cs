...
using static PlaywrightSharp.Helpers.CompatCollections;
    ...
    public static class PageCompatExtensions
    {
        ...
        public static Task AddInitScriptAsync(this IPage page, string script, object arg)
        {
            switch (page)
            {
                ...
                default:
                    throw new NotSupportedException("This page does not support PlaywrightSharp init-script arguments.");
            }
        }
        ...
        /// <summary>PlaywrightSharp coverage helper.</summary>
        public static ICoverage Coverage(this IPage page)
            => page is IHasPageExtras extras
                ? extras.Coverage
                : throw new NotSupportedException("This page does not expose PlaywrightSharp coverage.");
        ...
        internal static Task<AccessibilitySnapshotResult> SnapshotAccessibilityAsync(
            ...
            => page is IHasPageExtras extras
                ...
                : throw new NotSupportedException("This page does not expose PlaywrightSharp accessibility snapshots.");
        ...
        private static WaitUntilState ParseWaitUntilState(string waitUntil)
        {
            ...
            throw new PlaywrightSharpException($"Unknown waitUntil value: {waitUntil}");
        }
        ...
        private static RemoveAllListenersBehavior ParseRemoveAllListenersBehavior(string behavior)
        {
            ...
            throw new PlaywrightSharpException($"Unknown removeAllListeners behavior: {behavior}");
        }
        ...
        private static float? ParsePollingInterval(object polling)
        {
            ...
            if (polling is string pollingText)
            {
                ...
                throw new PlaywrightSharpException($"Unknown polling value: {pollingText}");
            }
            ...
            throw new PlaywrightSharpException($"Unknown polling value: {polling}");
        }
    }
}
