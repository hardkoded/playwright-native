...
#pragma warning disable CA1065 // Official frameLocator().first() throws when any-frame.
        public IFrameLocator First => _anyFrame
            ? throw new PlaywrightSharpException(NthNotAllowed)
...
#pragma warning restore CA1065
            ...
            Regex hasNotTextRegex = default)
        {
            ...
            return SelectorQuery.ApplyOptions(
                _anyFrame
                    ? PlaywrightSharp.Locator.InAnyFrame(_frame, selector)
        ...
        public ILocator GetByText(string text, bool? exact = null)
            => _anyFrame
                ? PlaywrightSharp.Locator.FromScript(_frame, GetByAllScript.FindAllByText, text, exact ?? false).WithAnyFrame()
                : RequireLocator(_iframe).EnterThenScript(GetByAllScript.FindAllByText, text, exact ?? false);

        /// <inheritdoc/>
        public ILocator GetByText(Regex text)
            => _anyFrame
                ? PlaywrightSharp.Locator.FromScript(
                    _frame,
        ...
        public ILocator GetByLabel(string text, bool? exact = null)
            => _anyFrame
                ? PlaywrightSharp.Locator.FromScript(_frame, GetByAllScript.FindAllByLabel, text, exact ?? false).WithAnyFrame()
        ...
        public ILocator GetByPlaceholder(string text, bool? exact = null)
            => _anyFrame
                ? PlaywrightSharp.Locator.FromScript(_frame, GetByAllScript.FindAllByAttribute, "placeholder", text, exact ?? false).WithAnyFrame()
        ...
        public ILocator GetByAltText(string text, bool? exact = null)
            => _anyFrame
                ? PlaywrightSharp.Locator.FromScript(_frame, GetByAllScript.FindAllByAttribute, "alt", text, exact ?? false).WithAnyFrame()
        ...
        public ILocator GetByTitle(string text, bool? exact = null)
            => _anyFrame
                ? PlaywrightSharp.Locator.FromScript(_frame, GetByAllScript.FindAllByAttribute, "title", text, exact ?? false).WithAnyFrame()
        ...
        public ILocator GetByTestId(string testId)
            => _anyFrame
                ? PlaywrightSharp.Locator.InAnyFrame(_frame, GetBySelectorScript.TestIdSelector(testId))
        ...
        private static Locator RequireLocator(ILocator other)
        {
            ...
            throw new ArgumentException("iframe locator must be a PlaywrightSharp locator.", nameof(other));
        }
