...
namespace PlaywrightSharp.Helpers
{
    ...
    return [
        ...
        internal static async Task PrepareAsync(IElementHandle handle, bool? force, float? timeout, bool? trial, Position position, ActionScroll scroll)
        {
            ...
            {
                throw new PlaywrightSharpException(NotAttachedMessage);
            }
            ...
            Func<Task> pressAsync)
        {
            ...
            while (true)
            {
                ...
                {
                    throw new PlaywrightSharpException("Unable to compute a click point for the element.");
                }
        ...
        internal static bool IsRetryable(Exception ex)
        {
            ...
            return PlaywrightSharpException.IsDestroyedContext(ex)
        ...
        private static async Task WaitActionableAsync(IElementHandle handle, float? timeout, bool? trial, Position position, ActionScroll scroll)
        {
            ...
            while (true)
            {
                ...
                catch (PlaywrightSharpException ex) when (ClosedTarget.IsClosed(ex))
                {
                    throw;
                }
                catch (PlaywrightSharpException)
    ...
    return n;
        ...
        private static async Task ThrowIfForceBlockedAsync(IElementHandle handle)
        {
            ...
            {
                throw new PlaywrightSharpException(NotVisibleMessage);
            }

            if (result == "notinviewport")
            {
                throw new PlaywrightSharpException(OutsideViewportMessage + "\nelement is outside of the viewport");
            }
        }
