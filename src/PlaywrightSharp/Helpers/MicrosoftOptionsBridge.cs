...
{
    /// <summary>
    /// Converts official <c>Microsoft.Playwright</c> option bags into PlaywrightSharp types.
    /// </summary>
    internal static class MicrosoftOptionsBridge
    {
        internal static PlaywrightSharp.TracingStartOptions ToTracingStartOptions(Microsoft.Playwright.TracingStartOptions options)
        {
            if (options == null)
            {
                return null;
            ...
            if (options is PlaywrightSharp.TracingStartOptions local)
            {
                return local;
            }

            return new PlaywrightSharp.TracingStartOptions
            {
                Live = options.Live,
