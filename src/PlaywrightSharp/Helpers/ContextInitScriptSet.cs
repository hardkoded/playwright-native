    ...
    internal sealed class ContextInitScriptSet
    {
            ...
            bool exposeFunctions)
        {
            if (exposeFunctions)
            {
                ...
                {
                    throw new PlaywrightSharpException(EvaluateCallbacks.InitScriptRequiresFunction);
                }
            ...
            {
                throw new PlaywrightSharpException(AddInitScriptHelper.MissingOptionsMessage);
            }
