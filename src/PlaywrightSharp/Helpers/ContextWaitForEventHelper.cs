            ...
            float? timeout)
        {
            ...
            switch (name)
            {
                ...
                case "ServiceWorker":
                    ...
                    {
                        throw new NotSupportedException("ServiceWorker events require a PlaywrightSharp browser context.");
                    }
                ...
                case "DialogClosed":
                    ...
                    {
                        throw new NotSupportedException("DialogClosed events require a PlaywrightSharp browser context.");
                    }
