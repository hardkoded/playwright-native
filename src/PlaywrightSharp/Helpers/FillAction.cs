...
namespace PlaywrightSharp.Helpers
{
    ...
    internal static class FillAction
    {
        ...
        /// <returns>A stackless <see cref="PlaywrightSharpException"/>.</returns>
        internal static PlaywrightSharpException Wrap(Exception ex, string apiName)
        {
            string name = string.IsNullOrEmpty(apiName) ? "page.fill" : apiName;
            return new PlaywrightSharpException(name + ": Error: " + Extract(ex) + "\nCall log:");
        }
