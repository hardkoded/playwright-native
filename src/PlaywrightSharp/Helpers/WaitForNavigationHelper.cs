    ...
    internal static class WaitForNavigationHelper
    {
            ...
            string apiName = "page.waitForNavigation")
        {
            ...
            void OnRequestFailed(object sender, IRequest request)
            {
                ...
                failureTcs.TrySetException(new PlaywrightSharpException(failure));
            }
            ...
            try
            {
                ...
                if (waitUntil != WaitUntilState.Commit)
                {
                    ...
                    catch (PlaywrightSharpException ex) when (ex.Message.Contains("frame was detached", StringComparison.OrdinalIgnoreCase))
                    {
