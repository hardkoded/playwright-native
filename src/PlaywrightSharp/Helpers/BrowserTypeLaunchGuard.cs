...
namespace PlaywrightSharp.Helpers
{
    ...
    internal static class BrowserTypeLaunchGuard
    {
        ...
        internal static void ThrowIfLaunchForbidden(BrowserTypeLaunchOptions options)
        {
            ...
            {
                throw new PlaywrightSharpException("Cannot specify a port without launching as a server.");
            }
        ...
        internal static void ThrowIfHeadedWithoutXServer(BrowserTypeLaunchOptions options)
        {
            ...
            {
                throw new PlaywrightSharpException(NoXServerRunningError);
            }
        }
        ...
        /// <returns>A wrapped <see cref="PlaywrightSharpException"/>.</returns>
        internal static PlaywrightSharpException WrapLaunch(string api, Exception ex)
        {
            string inner = RewriteStartupLog(ex?.Message ?? string.Empty);
            if (inner.StartsWith(api, StringComparison.Ordinal))
            {
                return ex as PlaywrightSharpException ?? new PlaywrightSharpException(inner, ex);
            }

            return new PlaywrightSharpException(api + ": " + inner + "\nBrowser logs:\n\n" + inner, ex);
        }
        ...
        /// <returns>A wrapped <see cref="PlaywrightSharpException"/>.</returns>
        internal static PlaywrightSharpException WrapConnectOverCdp(Exception ex, string browserLogs = null)
        {
