...
{
    /// <summary>
    /// Dispatches legacy PlaywrightSharp surface calls to concrete implementations when available.
    /// </summary>
    internal static class PageCompatDispatch
    {
        internal static IFrame FrameByUrl(IPage page, string urlString, Regex urlRegex, Func<string, bool> urlFunc)
            => page switch
            {
                ...
                _ => throw new NotSupportedException("FrameByUrl requires a PlaywrightSharp page."),
            };
        ...
        internal static Task RemoveAllListenersAsync(IPage page, string type, RemoveAllListenersBehavior behavior)
            => page switch
            {
                ...
                _ => throw new NotSupportedException("RemoveAllListenersAsync requires a PlaywrightSharp page."),
            };
        ...
        internal static Task EmulateVisionDeficiencyAsync(IPage page, VisionDeficiency type)
            => page switch
            {
                ...
                _ => throw new NotSupportedException("EmulateVisionDeficiencyAsync requires a PlaywrightSharp page."),
            };
        ...
        internal static Task<IReadOnlyList<string>> PageErrorsAsync(IPage page, PageErrorsFilter filter)
            => page switch
            {
                ...
                _ => throw new NotSupportedException("PageErrorsAsync requires a PlaywrightSharp page."),
            };
        ...
        internal static Task<IReadOnlyList<IRequest>> RequestsAsync(IPage page)
            => page switch
            {
                ...
                _ => throw new NotSupportedException("RequestsAsync requires a PlaywrightSharp page."),
            };
    }
}
