...
namespace PlaywrightSharp.Helpers
{
    ...
    internal static class BrowserContextOptionGuard
    {
        ...
        internal static void ThrowIfInvalidProxy(Proxy proxy)
        {
            ...
            {
                throw new PlaywrightSharpException("Socks4 proxy protocol does not support authentication");
            }

            if (server.StartsWith("socks5:", System.StringComparison.OrdinalIgnoreCase))
            {
                throw new PlaywrightSharpException("Browser does not support socks5 proxy authentication");
            }
        }
