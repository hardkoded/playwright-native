...
namespace PlaywrightSharp.Helpers
{
    ...
    public static class StringExtensions
    {
        ...
        {
            string pattern = UrlMatcher.GlobToRegexPattern(glob);
            return pattern == null ? null : new Regex(pattern);
        }
        ...
        internal static bool UrlMatches(this string url, string glob) => UrlMatcher.UrlMatches(null, url, glob);
