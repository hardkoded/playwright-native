    ...
    internal sealed class ContextExposedRegistry : IHasExposedFunctionNames
    {
            ...
            Func<IPage, bool> pageHasName)
        {
            ...
            lock (_lock)
            {
                ...
                {
                    throw new PlaywrightSharpException(PageBindingScript.AlreadyRegistered(name));
                }
            }
            ...
            foreach (IPage page in existing)
            {
                ...
                {
                    throw new PlaywrightSharpException(PageBindingScript.AlreadyRegisteredInOneOfThePages(name));
                }
            }
