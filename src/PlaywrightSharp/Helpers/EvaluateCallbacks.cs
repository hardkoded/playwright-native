...
namespace PlaywrightSharp.Helpers
{
  ...
  return o;
            ...
            bool runOnCurrentDocument = false)
        {
            if (page == null)
            {
                throw new PlaywrightSharpException("Passing a function is not supported as an argument here");
            }
            ...
            {
                throw new PlaywrightSharpException(InitScriptRequiresFunction);
            }
        ...
        internal static void ThrowIfHasFunctions(object arg)
        {
            if (TryFindFunction(arg, string.Empty, out string path))
            {
                ...
                {
                    throw new PlaywrightSharpException("Attempting to serialize unexpected value: () => {}");
                }
        ...
        private static Task<T> EvaluateExistingAsync<T>(object target, string expression, object arg)
        {
            ...
            throw new PlaywrightSharpException("Cannot evaluate on this target.");
        }
