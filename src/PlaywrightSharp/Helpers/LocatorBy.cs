...
namespace PlaywrightSharp.Helpers
{
    ...
    internal static class LocatorBy
    {
        ...
        internal static ILocator Bind(IPage page, IBy by)
        {
            ...
            return PlaywrightSharp.By.Resolve(by, new PageFactory(page));
        }
        ...
        internal static ILocator Bind(IFrame frame, IBy by)
        {
            ...
            return PlaywrightSharp.By.Resolve(by, new FrameFactory(frame));
        }
        ...
        internal static ILocator Bind(ILocator locator, IBy by)
        {
            ...
            return PlaywrightSharp.By.Resolve(by, new LocatorFactory(locator));
        }
        ...
        internal static ILocator Bind(IFrameLocator frameLocator, IBy by)
        {
            ...
            return PlaywrightSharp.By.Resolve(by, new FrameLocatorFactory(frameLocator));
        }
