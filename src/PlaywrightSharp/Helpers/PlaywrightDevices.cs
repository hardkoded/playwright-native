...
namespace PlaywrightSharp.Helpers
{
    ...
    internal static class PlaywrightDevices
    {
        ...
        internal static IReadOnlyDictionary<string, BrowserContextOptions> Load()
        {
            ...
            using Stream stream = assembly.GetManifestResourceStream("PlaywrightSharp.Helpers.deviceDescriptorsSource.json")
                ?? throw new PlaywrightSharpException("Bundled Playwright device descriptors are missing.");
