    ...
    internal static class EvalOnSelector
    {
            ...
            string apiName = null)
        {
            ...
            if (handle == null)
            {
                ...
                throw new PlaywrightSharpException(prefix + "Failed to find element matching selector \"" + selector + "\"");
            }
            ...
            object arg)
        {
            ...
            if (array == null)
            {
                throw new PlaywrightSharpException("Failed to create an element array for evaluation.");
            }
