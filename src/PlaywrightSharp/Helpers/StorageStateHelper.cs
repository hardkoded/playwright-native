...
namespace PlaywrightSharp.Helpers
{
    ...
    internal static class StorageStateHelper
    {
            ...
            bool replaceExisting = false)
        {
            ...
            catch (Exception ex) when (ex is PlaywrightSharpException || ex is ArgumentException)
            {
                ...
                throw new PlaywrightSharpException("Error setting storage state:\n" + ex.Message);
            }
        }
...
#pragma warning restore RCS1075
        ...
        private static async Task GoToOriginAsync(IPage page, StorageStateOrigin origin)
        {
            ...
            foreach (string url in candidates)
            {
                ...
                catch (Exception ex) when (ex is NavigationException || ex is PlaywrightSharpException)
                {
                    last = ex;
                }
            }
