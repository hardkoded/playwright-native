...
using PlaywrightNative.NUnit.TestExpectations;
...
namespace PlaywrightNative.NUnit
{
    ...
    public class PlaywrightTestAttribute : NUnitAttribute, IApplyToTest
    {
        ...
        private static TestExpectation[] GetLocalExpectations() =>
            _localExpectations ??= LoadExpectationsFromResource("PlaywrightNative.NUnit.TestExpectations.TestExpectations.local.json");
