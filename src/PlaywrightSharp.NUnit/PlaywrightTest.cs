...
/// <summary>
/// PlaywrightSharp NUnit fixture that selects the browser product and exposes
...
/// not call <c>Microsoft.Playwright.Playwright.CreateAsync()</c> — PlaywrightSharp
/// launches browsers through <see cref="PlaywrightSharp.Playwright"/> directly.
/// </remarks>
public class PlaywrightTest : WorkerAwareTest
{
    ...
    /// <summary>
    /// Gets the PlaywrightSharp <see cref="IBrowserType"/> for <see cref="BrowserName"/>.
    /// </summary>
    ...
    public void PlaywrightSetup()
    {
        ...
        {
            "firefox" => PlaywrightSharp.Playwright.Firefox,
            "webkit" => PlaywrightSharp.Playwright.Webkit,
            _ => PlaywrightSharp.Playwright.Chromium,
        };
        ...
        {
            PlaywrightSharp.Playwright.SetTestIdAttribute(testIdAttribute);
        }
    }
    ...
    public static void SetDefaultExpectTimeout(float timeout)
        => PlaywrightSharp.Assertions.SetDefaultExpectTimeout(timeout);

    /// <summary>Creates locator assertions.</summary>
    public ILocatorAssertions Expect(ILocator locator) => PlaywrightSharp.Assertions.Expect(locator);

    /// <summary>Creates page assertions.</summary>
    public IPageAssertions Expect(IPage page) => PlaywrightSharp.Assertions.Expect(page);

    /// <summary>Creates API response assertions.</summary>
    public IAPIResponseAssertions Expect(IAPIResponse response) => PlaywrightSharp.Assertions.Expect(response);
