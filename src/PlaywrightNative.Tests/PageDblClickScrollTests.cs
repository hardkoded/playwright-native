...
{
    /// <summary>
    /// Official <c>scroll</c> option on <see cref="IPage.DblClickAsync"/>.
    /// </summary>
    [TestFixture]
    public class PageDblClickScrollTests : PageTestEx
    {
        [PlaywrightTest("page-click.spec.ts", "DblClick Auto scrolls the target into view")]
        [Test]
        [Timeout(30_000)]
        public async Task AutoShouldScrollTheTargetIntoView()
        {
            ...
            await page.DblClickAsync("#btn").ConfigureAwait(false);
        ...
        [PlaywrightTest("page-click.spec.ts", "DblClick scroll None does not scroll")]
        [Test]
        [Timeout(30_000)]
        public async Task ScrollNoneShouldNotScrollThePage()
        {
            ...
            await page.DblClickAsync("#btn", new() { Force = true, Scroll = ScrollMode.None }).ConfigureAwait(false);
            double after = await page.EvaluateAsync<double>("document.getElementById('box').scrollTop").ConfigureAwait(false);
