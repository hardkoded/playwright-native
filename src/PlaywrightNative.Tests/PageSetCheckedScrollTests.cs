...
{
    /// <summary>
    /// Official <c>scroll</c> option on <see cref="IPage.SetCheckedAsync"/>.
    /// </summary>
    [TestFixture]
    public class PageSetCheckedScrollTests : PageTestEx
    {
        [PlaywrightTest("page-check.spec.ts", "SetChecked Auto scrolls the target into view")]
        [Test]
        [Timeout(30_000)]
        public async Task AutoShouldScrollTheTargetIntoView()
        {
            ...
            await page.SetCheckedAsync("#btn", true).ConfigureAwait(false);
        ...
        [PlaywrightTest("page-check.spec.ts", "SetChecked scroll None does not scroll")]
        [Test]
        [Timeout(30_000)]
